          ...
          <div className="lg:col-span-8 space-y-12 lg:space-y-16">
            <FadeIn direction="up">
              <div className="flex items-center gap-6 mb-8">
                ...
                <p className="text-[10px] font-mono font-bold uppercase tracking-[0.4em] text-accent">Briefing Profile: {PERSONAL_INFO.name}</p>
              </div>
              ...
              <h2 className="text-4xl md:text-5xl lg:text-7xl font-serif font-bold text-ink dark:text-white leading-[1.05] tracking-tighter text-balanced">
                I am a <span className="text-accent italic">passionate builder</span>. 
                I love building <span className="underline decoration-accent/10 decoration-2 underline-offset-8">cool stuff</span> within <span className="text-accent">AI</span> and am focused on advancing my career at the <span className="italic font-normal">frontier of artificial intelligence</span>.
              </h2>
            </FadeIn>
            ...
            <div className="relative pt-8 lg:pt-12">
              ...
              >
                Visionary<br/>
                <span className="italic font-normal text-zinc-300 dark:text-zinc-700 underline decoration-accent/10 decoration-4 underline-offset-8">Architect.</span>
              </motion.h1>
            </div>
          </div>
            ...
            <FadeIn delay={0.2} direction="right">
              <div className="space-y-8 bg-zinc-50 dark:bg-zinc-900/40 p-8 lg:p-10 border border-magazine rounded-sm relative group overflow-hidden shadow-sm">
                 ...
                 <p className="text-xl font-serif italic opacity-80 leading-relaxed text-ink dark:text-white">
                   "Solving real-world problems with high-bandwidth intelligence through agentic systems."
                 </p>
              </div>
            </FadeIn>
              ...
              <div className="space-y-8 lg:space-y-10">
                <div className="p-8 border border-magazine bg-white/50 dark:bg-black/20 backdrop-blur-sm rounded-sm">
                   ...
                   <ul className="space-y-4 text-sm font-serif italic text-ink/70 dark:text-white/70">
                     <li>Multimodal Tool Building</li>
                     <li>Quantum Logic Exploration</li>
    ...
    <Layout>
      ...
      <footer className="pt-32 pb-16 border-t border-magazine relative overflow-hidden">
         <div className="mb-24 lg:mb-48 text-center lg:text-left">
           <FadeIn direction="up">
             <p className="text-[10px] lg:text-[11px] font-mono font-bold uppercase tracking-[2em] opacity-10 mb-16 lg:mb-20 text-ink dark:text-white">Transmission_End</p>
